#!/usr/bin/env python3
"""
Best Football Edits 2025 (TikTok/Reels) — Shorts pipeline
Already vertical 9:16 content pillarboxed in 16:9. Centre crop removes red bars + RMHD logo.
Schedules Jun 19-28 17:00 BST to fill the schedule gap.
"""
...
SRC          = Path('/home/user/ClaudeCode/mxm_shorts/downloads/Best_Football_Edits_2025_1080p.mp4')
CLIPS_DIR    = Path('/home/user/ClaudeCode/mxm_shorts/clips/football_edits')
SHORTS_DIR   = Path('/home/user/ClaudeCode/mxm_shorts/processed/football_edits')
MUSIC_FILES  = [
...
SHORT_PUBLISH = [f'2026-06-{d:02d}T16:00:00Z' for d in range(19, 29)]

SHORT_TITLES = [
    "Football_Moments_Breaking_The_Internet_2025",
    "When_Football_Was_Pure_Entertainment",
    "The_Football_Edit_Everyone_Is_Talking_About",
    "Goals_Skills_And_Fails_All_In_One",
    "Football_2025_You_Wont_Believe_This",
    "When_Football_Goes_Completely_Wrong",
    "The_Football_Clip_Everyone_Shared",
    "Football_Highlights_That_Hit_Different",
    "Best_Football_Moments_From_2025",
    "Top_Football_Edits_2025",
]
...
SHORT_DESC = (
    "\U0001f525 Best football moments of 2025!\n\n"
    "#Shorts #Football #FootballEdits #Skills #Goals #Fails #mxmballers #Football2025"
)
SHORT_TAGS = ['Shorts', 'Football', 'FootballEdits', 'Skills', 'Goals', 'Fails',
              'mxmballers', 'Football2025', 'FootballHighlights', 'BestFootball']
...
def process_short(raw_path, out_path, hook_text, music_path):
    ...
    vf = (
        ...
        # Cover DKR watermark that appears bottom-centre in some TikTok clips
        f"drawbox=x=(w-220)/2:y=h-90:w=220:h=55:color=black:t=fill,"
...
def main():
    ...
    print('=== Best Football Edits 2025 — Shorts Pipeline ===\n')
    ...
    folder_id = get_or_create_folder('Best Football Edits 2025 Shorts', DRIVE_ROOT, drive_token)
    ...
    for i, (start, end) in enumerate(segments, 1):
        ...
        stem     = SHORT_TITLES[i-1] if i <= len(SHORT_TITLES) else f'Football_Edit_{i}'
        out_path = SHORTS_DIR / f'{stem}.mp4'
        publish  = SHORT_PUBLISH[i-1]
        title    = f"{stem.replace('_', ' ')} #Shorts #Football"
    ...
    print(f'\n=== Done — {len(segments)} Shorts scheduled Jun 19-28 ===')
