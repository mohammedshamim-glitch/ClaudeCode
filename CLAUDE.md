...
- **mxm ballers music**: Active playlist: `last_second_victory.mp3`, `under_the_floodlights.mp3`, `under_stadium_lights.mp3` (all in `mxm_shorts/music/`). Concatenate all three into `music_combined.mp3` via ffmpeg concat, then loop with `-stream_loop -1`. For future videos also consider `Pitchside_Glory.mp3` (Drive ID: `1N3vwhaw_-i2nV8JWaVp3uJWZedC9XxkZ`) — not yet added to playlist. Old tracks `upbeat_background_1.mp3` and `upbeat_background_2.mp3` are retired (copyright issues).
