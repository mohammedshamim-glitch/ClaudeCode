...
- **mxm ballers music**: Default track is `mxm_shorts/music/last_second_victory.mp3` — use this for all new Shorts and full videos. Loop to fit with ffmpeg `-stream_loop -1`. Old tracks `upbeat_background_1.mp3` and `upbeat_background_2.mp3` are retired (copyright issues).
